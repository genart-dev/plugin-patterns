...
CATEGORIES=(
  fill stripe dot checker wave crosshatch-geo herringbone tile
  triangle diamond hexagon star circle
  japanese lattice plaid cube leaf
  floral memphis eye spiral terrazzo
  square octagon scale chainlink ethnic
)
